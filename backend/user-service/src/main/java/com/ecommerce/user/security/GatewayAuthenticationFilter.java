 ...
 * JWT, or set by another internal service (e.g. order-service) acting under its own trusted
 * ROLE_ORDER_SERVICE identity. This service never re-parses the JWT itself.
 */
@Slf4j
